...
export K8S_VERSION=${K8S_VERSION:-v1.34.2} # renovate: datasource=github-releases depName=kubernetes/kubernetes
export CRICTL_VERSION=${CRICTL_VERSION:-v1.34.0} # renovate: datasource=github-releases depName=kubernetes-sigs/cri-tools
export RUNC_VERSION=${RUNC_VERSION:-v1.3.4} # renovate: datasource=github-releases depName=opencontainers/runc
export CNI_PLUGINS=${CNI_PLUGINS:-v1.7.1} # renovate: datasource=github-releases depName=containernetworking/plugins
export CONTAINERD_VERSION=${CONTAINERD_VERSION:-2.1.5} # renovate: datasource=github-releases depName=containerd/containerd
...
export HELM_VERSION=${HELM_VERSION:-v3.19.2} # renovate: datasource=github-releases depName=helm/helm
...
export SYFT_VERSION=${SYFT_VERSION:-v1.34.2} # renovate: datasource=github-releases depName=anchore/syft
