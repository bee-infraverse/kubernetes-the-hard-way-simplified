...
export ETCD_VERSION=${ETCD_VERSION:-v3.6.3} # renovate: datasource=github-releases depName=etcd-io/etcd
...
export TRIVY_VERSION=${TRIVY_VERSION:-v0.60.0} # renovate: datasource=github-releases depName=aquasecurity/trivy
...
export REGCTL_VERSION=${REGCTL_VERSION:-v0.90.0} # renovate: datasource=github-releases depName=regclient/regclient
